...
<p align="center">
  ...
  <a href="https://wa.me/6283824417034"><img src="https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" />
...
case 'youtube_audio':  
      ...
      reply(lang.wait()) 
      anu = await fetchJson(`https://api-naknolep.herokuapp.com/api/yutub/audio?url=${args[0]}&apikey=Alphabot`)
...
case 'hadist_sahih':
      ...
      kitab = get_args[0]
      nomor = get_args[1]
      var hadist = await fetchJson('https://api-naknolep.herokuapp.com/api/hadits?kitab=${kitab}&nomor=${nomor}&apikey=Alphabot')
...
case 'wallpaper_programming':
     get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/wallpaper/teknologi?apikey=Alphabot`)
...
case 'random_quote':
     ini_result = await fetchJson('https://api-naknolep.herokuapp.com/api/randomquote?apikey=Alphabot')
...
case 'maker_2d':
      ...
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/maker?text=${teksnya}&apikey=Alphabot`}
      get_result = ini_result.result
...
case 'maker_3d':
      if (args.length < 1) return reply(`Usage: ${prefix + command} teks\nExample : ${prefix + command} dhaffnavyz)
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/maker3d?text=${teksnya}&apikey=Alphabot`}
      get_result = ini_result.result
         ini_img = await getBuffer(get_result.results)
      alpha.sendMessage(from, ini_img, image,{quoted :mek, caption : 'Nih kak hasilnya'})
      break
...
case 'asupan_santuy':
     ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/asupan/santuy?apikey=Alphabot`)
     get_result = ini_result.result
...
case 'nsfw_ass':
     ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/nsfw/ass?apikey=Alphabot`)
     get_result = ini_result.result
...
case 'cewe_vietnam':
     ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/cewe/vietnam?apikey=Alphabot`)
     get_result = ini_result.result
        ini_img = await getBuffer(get_result.url)
     alpha.sendMessage(from, ini_img, image, {quoted:mek})
     break
...
case 'cari_film':
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/filmapik/search?film=${query}&apikey=Alphabot`)
      for (var x = 0; x <= 1; x++) {
...
case 'lk21_tahun': //mencari film lk21 berdasarkan tahun
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/lk21/year?tahun=${query}&apikey=Alphabot`)
      for (var x = 0; x <= 1; x++) {
...
case 'republika': 
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/news/republika?type=${query}&apikey=Alphabot`)
      for (var x = 0; x <= 1; x++) {
         ini_txt = `DATA BERHASIL DI TEMUKAN\n\n`
...
case 'base64encode':
      if (args.length < 1) return reply(`Usage : ${prefix + command} teks\nExample : ${prefix + command} dhaffnavyz)
      query = args.join(" ")
      ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/base?apikey=Alphabot&type=base64&encode=${query}`)
      get_result = ini_result.result
...
case 'covid_word':
     ini_result = await fetchJson('https://api-naknolep.herokuapp.com/api/covidworld?apikey=Alphabot')
     get_result = ini_result.result
