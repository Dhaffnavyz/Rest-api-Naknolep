...
<a href="https://github.com/dhaffnavyz/api-dhaffnavyz/stargazers/"><img title="Stars" src="https://img.shields.io/github/stars/dhaffnavyz/api-dhaffnavyz?color=blue&style=flat-square"></a>
<a href="https://github.com/dhaffnavyz/api-dhaffnavyz/network/members"><img title="Forks" src="https://img.shields.io/github/forks/dhaffnavyz/api-dhaffnavyz?color=red&style=flat-square"></a>
<a href="https://github.com/dhaffnavyz/api-dhaffnavyz/watchers"><img title="Watching" src="https://img.shields.io/github/watchers/dhaffnavyz/api-dhaffnavyz?label=Watchers&color=blue&style=flat-square"></a>
...
## ```Connect with me```
<p align="center">
  <a href="https://instagram.com/dhaffnavyz"><img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white"/> 
...
case 'youtube_audio':  
      ...
      reply(lang.wait()) 
      anu = await fetchJson(`https://api-naknolep.herokuapp.com/api/yutub/audio?url=${args[0]}&apikey=naknolep`)
...
case 'hadist_sahih':
      ...
      kitab = get_args[0]
      nomor = get_args[1]
      var hadist = await fetchJson('https://api-naknolep.herokuapp.com/api/hadits?kitab=${kitab}&nomor=${nomor}&apikey=naknolep')
...
case 'wallpaper_programming':
     get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/wallpaper/teknologi?apikey=naknolep`)
...
case 'random_quote':
     ini_result = await fetchJson('https://api-naknolep.herokuapp.com/api/randomquote?apikey=naknolep')
...
case 'maker_2d':
      ...
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/maker?text=${teksnya}&apikey=naknolep`}
      get_result = ini_result.result
...
case 'maker_3d':
      if (args.length < 1) return reply(`Usage: ${prefix + command} teks\nExample : ${prefix + command} dhaffnavyz)
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/maker3d?text=${teksnya}&apikey=naknolep`}
      get_result = ini_result.result
         ini_img = await getBuffer(get_result.results)
      dhaff.sendMessage(from, ini_img, image,{quoted :mek, caption : 'Nih kak hasilnya'})
      break
...
case 'sertifikat_ff':
      if (args.length < 1) return reply(`Usage: ${prefix + command} teks\nExample : ${prefix + command} dhaffnavyz)
      teksnya = args.join(" ")
      ini_result = await fetchJson(`api-naknolep.herokuapp.com/api/maker/special/epep?text=${teksnya}&apikey=naknolep`}
      get_result = ini_result.result
         ini_img = await getBuffer(get_result.results)
      dhaff.sendMessage(from, ini_img, image,{quoted :mek, caption : 'Nih kak hasilnya'})
      break
...
case 'coffe_cup':
      if (args.length < 1) return reply(`Usage: ${prefix + command} teks\nExample : ${prefix + command} dhaffnavyz)
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://percobaannih.herokuapp.com/api/textmaker/senja?text=${teksnya}&theme=coffee-cup&apikey=naknolep`}
      get_result = ini_result.result
...
case 'manga':
      ...
      query = args.join(" ")
      var manga = await fetchJson('https://percobaannih.herokuapp.com/api/anime/kusonime?search=${query}&apikey=naknolep')
...
case 'asupan_santuy':
     ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/asupan/santuy?apikey=naknolep`)
     get_result = ini_result.result
...
case 'nsfw_ass':
     ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/nsfw/ass?apikey=naknolep`)
     get_result = ini_result.result
...
case 'cewe_vietnam':
     ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/cewe/vietnam?apikey=naknolep`)
     get_result = ini_result.result
        ini_img = await getBuffer(get_result.url)
     dhaff.sendMessage(from, ini_img, image, {quoted:mek})
     break
...
case 'cari_film':
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/filmapik/search?film=${query}&apikey=naknolep`)
      for (var x = 0; x <= 1; x++) {
...
case 'lk21_tahun': //mencari film lk21 berdasarkan tahun
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/lk21/year?tahun=${query}&apikey=naknolep`)
      for (var x = 0; x <= 1; x++) {
...
case 'republika': 
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/news/republika?type=${query}&apikey=naknolep`)
      for (var x = 0; x <= 1; x++) {
         ini_txt = `DATA BERHASIL DI TEMUKAN\n\n`
...
case 'base64encode':
      if (args.length < 1) return reply(`Usage : ${prefix + command} teks\nExample : ${prefix + command} dhaffnavyz)
      query = args.join(" ")
      ini_result = await fetchJson(`https://api-naknolep.herokuapp.com/api/base?apikey=naknolep&type=base64&encode=${query}`)
      get_result = ini_result.result
...
case 'covid_word':
     ini_result = await fetchJson('https://api-naknolep.herokuapp.com/api/covidworld?apikey=naknolep')
     get_result = ini_result.result
